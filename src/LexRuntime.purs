...
postContent = Request.request service method  where
    service = Request.ServiceName "LexRuntime"
    method = Request.MethodName "postContent"
...
postText = Request.request service method  where
    service = Request.ServiceName "LexRuntime"
    method = Request.MethodName "postText"
